...
public class PhotonVoiceRecorder : Photon.MonoBehaviour
{
    ...
    public bool Transmit { get {return this.voice.Transmit; } set{ this.voice.Transmit = value;} }

    /// <summary>If true, voice detection enabled.</summary>
	public bool Detect { get {return this.voice.VoiceDetector.On; } set{ this.voice.VoiceDetector.On = value;} }
